 ...
 % COLOR SCALE GIVEN BY INTPUT PARAMETER TO COMPARE DIFFERENT IMAGES
 % before scale: vr=sqrt(u.^2+v.^2);
...
alpha = 0.6533; % Size of arrow head relative to the length of the vector
...
if scale == 0
  ...
  maxvr = autoscale*scale;
end

vrn=round(vr/maxvr*64);
CC=colormap;
ax = newplot;
