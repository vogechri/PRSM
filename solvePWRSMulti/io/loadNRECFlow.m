function [cam, ref, logName, flow2DGt, flow2DGt_noc] = ...
...
% since no ground truth comes with this dataset.
%
%
...
ImgL{1} = double(rgb2gray(imread(fullfile(imageDir,imagesLeft{index}))))/255;
