...
/*!
 * \class My_QuaternionT
 * \brief A class for quaternions with several functions.
 *
 * A class for quaternions with several functions. 
 * Besides standard functions like conversion from and to
 * a rotation matrix, linear or sphericl linear interpolation of quaternions are
 * possible.
 *
 * \author C.Vogel
 * 
...
#define Z_ this->values_[3]
  ...
  typedef typename QuaternionT<Scalar> Base;
